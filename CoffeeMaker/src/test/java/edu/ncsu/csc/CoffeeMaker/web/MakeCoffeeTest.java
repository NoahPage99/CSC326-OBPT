...
public class MakeCoffeeTest extends SeleniumTest {
     ...
     *
     */
    // private void makeCoffee ( final String recipeName, final int price, final
    // int amtCoffee, final int amtMilk,
    // final int amtSugar, final int amtChocolate, final int paid, final String
    // expectedMessage )
    // throws Exception {
    // createRecipe( recipeName, price, amtCoffee, amtMilk, amtSugar,
    // amtChocolate );
    ...
    // final WebElement radioButton = driver.findElement( By.cssSelector(
    // "input[name='name']" ) );

    // radioButton.click();

    // final WebElement payment = driver.findElement( By.cssSelector(
    // "input[name='amtPaid']" ) );
